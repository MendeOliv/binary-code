export class ContextBuilder {
    encoding; // placeholder for tiktoken if we want to add later
    constructor() {
     ...
     */
    buildContext(retrievedItems, tokenLimit = 6000) {
        ...
        const appendSection = (title, items) => {
            ...
            for (let idx = 0; idx < items.length; idx++) {
                ...
                if (currentTokens +
                    ...
                    itemTokens >
                    tokenLimit) {
                    console.log(`Token limit of ${tokenLimit} reached. Omitting subsequent context items in ${title}.`);
                    break;
                }
